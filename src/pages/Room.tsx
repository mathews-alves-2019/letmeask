        ...
        <div id="page-room">
            ...
            <main className="content">
                ...
                <form onSubmit={ handleSendQuestion }>
                    <textarea placeholder="O que você quer perguntar?" onChange={ event => setNewQuestion(event.target.value) }
                    value={ newQuestion }/>
                        ...
                        questions.map(question => {
                            return (
                                <Question content={question.content} author={question.author} key={question.id} >
                                    <button className={`like-button ${ question.likeId ? 'liked' : ''}`} type="button" onClick={() => handleLikeQuestion(question.id, question.likeId)}
